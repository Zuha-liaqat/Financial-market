      ...
      <div className="flex flex-col gap-3">
          ...
          <div className="rounded-lg border border-neutral-200 bg-neutral-50 p-4">
            ...
            <div className="grid grid-cols-2 max-sm:grid-cols-1 gap-3">
              <div>
                <label htmlFor="blog-schedule-date" className="mb-1.5 block text-xs font-medium text-neutral-500">
              ...
              <div>
                <label htmlFor="blog-schedule-time" className="mb-1.5 block text-xs font-medium text-neutral-500">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-sm rounded-xl bg-white p-8 shadow-2xl">
            <div className="flex flex-col items-center">
              ...
              <h3 className="animate-shimmer-text mt-5 text-lg font-semibold">Generating your blog post</h3>
